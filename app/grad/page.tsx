...
export default function GradPage() {
  // Gallery items array — replace these with graduation portrait images
  const galleryItems = [
    {
      id: 1,
      type: "image",
      src: "/images/headshots-gallery/headshot-portland-AB8I9699-Edit.jpg",
      alt: "Graduation portrait photography example",
    },
    {
      id: 2,
      type: "image",
              ...
              <div className="flex flex-col md:flex-row justify-between items-center">
                ...
                <nav>
                  <ul className="flex flex-wrap justify-center gap-4 md:gap-6 text-sm">
                    ...
                    <li>
                      <Link href="/grad" className="bg-white text-[#247BA0] px-4 py-2 rounded">
                        GRAD
                      </Link>
                    </li>
                    <li>
