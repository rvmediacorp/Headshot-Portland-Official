...
export default function TrustBar() {
  return (
    <p
      className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1 text-center text-[13px] font-medium text-[#444] sm:text-sm lg:text-[#333]"
    ...
    >
      <span className="inline-flex items-center gap-1.5">
        ...
        <Star
          className="h-3.5 w-3.5 fill-[#FFB300] text-[#FFB300]"
          aria-hidden
        />
