...
export default function ForTeamsPage() {
  // Gallery items array — replace these with team headshot images
  const galleryItems = [
    {
      id: 1,
      type: "image",
      src: "/images/headshots-gallery/headshot-portland-AB8I9699-Edit.jpg",
      alt: "Team headshot photography example",
    },
    {
      id: 2,
      type: "image",
              ...
              <div className="flex flex-col md:flex-row justify-between items-center">
                ...
                <nav>
                  <ul className="flex flex-wrap justify-center gap-4 md:gap-6 text-sm">
                    ...
                    <li>
                      <Link href="/for-teams" className="bg-white text-[#247BA0] px-4 py-2 rounded">
                        FOR TEAMS
                      </Link>
                    </li>
                    <li>
