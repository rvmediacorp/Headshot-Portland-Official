  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {/* Add more examples with different data */}
        <VideoReview 
          videoSrc="/videos/example-video-landscape.mp4"
          thumbnailSrc="/confident-businessman.png"
          authorName="James Wilson"
          authorTitle="Marketing Director"
          authorCompany="Tech Innovations"
          reviewText="Working with this photography studio was an excellent experience. They made the process enjoyable and delivered professional results that exceeded my expectations."
          rating={5}
          className="aspect-video" // For landscape video
        />

        {/* Add a third example */}
        <VideoReview 
          videoSrc="/videos/example-video.mp4"
          thumbnailSrc="/confident-latina-professional.png"
          authorName="Sofia Rodriguez"
          authorTitle="CEO"
          authorCompany="Brightway Solutions"
          reviewText="The headshots I received are perfect for my professional branding. The photographer knew exactly how to capture my personality while maintaining a polished look."
          rating={4}
        />
      </div>
